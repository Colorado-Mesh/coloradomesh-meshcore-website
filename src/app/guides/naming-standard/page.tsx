...
export const metadata: Metadata = {
  title: "Node Naming Standard v2.0 | Denver MeshCore",
  description: "Denver MeshCore node naming standard v2.0. Interactive wizard for generating valid repeater and room server names. Companion naming instructions included.",
  ...
  openGraph: {
    title: "Node Naming Standard v2.0 | Denver MeshCore",
    description: "Interactive wizard for naming your Denver MeshCore nodes following the v2.0 standard.",
